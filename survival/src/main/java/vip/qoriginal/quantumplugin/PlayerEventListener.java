...
public class PlayerEventListener implements Listener {
    ...
    public void onPlayerExpChange(PlayerExpChangeEvent event) {
        ...
        cj.push(
                () ->{
                    try {
                        Request.sendPostRequest(Config.INSTANCE.getAPI_ENDPOINT() + "/qo/upload/explevel?token=" + Config.INSTANCE.getAPI_SECRET() + "&username=" + player.getName() + "&lvl=" + finalNewLevel, "");
                    } catch (Exception e) {
